...
void Chunk::rebuild() {
    ...
    // 4J - TODO - now our data has been re-arranged, we could
                ...
                for (int y = y0; y < y1; y++) {
                    ...
                    if (tileId > 0) {
                        if (!started) {
                            ...
                            // no more translateToPos()
                            // vertices are stored in world space and the camera
                            // translate in renderChunks handles positioning.
                            t->begin();
                            // worldspace !
...
// remove ps3 because well it wont work and we don't plan to go ps3
