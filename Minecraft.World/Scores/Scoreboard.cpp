...
Objective* Scoreboard::addObjective(const std::wstring& name,
    ...
    //
    //	std::vector<Objective *> *criteriaList =
...
std::vector<Objective*>* Scoreboard::findObjectiveFor(ObjectiveCriteria* criteria) {
    ...
    // return objectives == NULL ? new std::vector<Objective *>() : new
    // std::vector<Objective *>(objectives);
}

Score* Scoreboard::getPlayerScore(const std::wstring& name, Objective* objective) {
    return NULL;
    // std::unordered_map<Objective *, Score *> *scores =
    // playerScores.find(name)->it;

    // if (scores == NULL)
    //{
    //	scores = new std::unordered_map<Objective *, Score *>();
...
void Scoreboard::resetPlayerScore(const std::wstring& player) {
    // std::unordered_map<Objective *, Score *> *removed =
