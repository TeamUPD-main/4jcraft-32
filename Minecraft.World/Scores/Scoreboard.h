...
private:
    ...
    std::unordered_map<std::wstring, std::unordered_map<Objective*, Score*> > playerScores;
...
public:
    ...
    std::unordered_map<Objective*, Score*>* getPlayerScores(const std::wstring& player);
