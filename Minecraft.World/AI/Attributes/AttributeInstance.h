...
public:
    ...
    virtual std::unordered_set<AttributeModifier*>* getModifiers(int operation) = 0;
    virtual void getModifiers(std::unordered_set<AttributeModifier*>& result) = 0;
    virtual AttributeModifier* getModifier(eMODIFIER_ID id) = 0;
    virtual void addModifiers(std::unordered_set<AttributeModifier*>* modifiers) = 0;
